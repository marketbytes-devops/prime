              ...
              {currentPairs.length === 0 ? (
                ...
                currentPairs.map((pair, index) => (
                  <tr key={pair.id} className="border hover:bg-gray-50">
                    ...
                    <td className="border p-2 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          disabled={isSubmitting || !hasPermission('processed_invoices', 'view') || !pair.deliveryNoteItem?.invoice_file}
                          className={`px-3 py-1 rounded-md text-sm whitespace-nowrap ${
                            isSubmitting || !hasPermission('processed_invoices', 'view') || !pair.deliveryNoteItem?.invoice_file
                              ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                    ...
                    <td className="border p-2 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <span className="text-xs text-gray-600">{pair.deliveryNoteItem?.invoice_status || 'Processed'}</span>
                        <select
