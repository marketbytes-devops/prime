...
<h3 style="text-align: center; margin-bottom: 20px;">Terms & Conditions</h3>
<h4 style="margin-bottom: 15px;">Calibration Service General Terms and Conditions</h4>
...
<p><strong>• Calibration Methods:</strong> Prime Innovation is committed to employing calibration methods that are suitable for the specific calibration tasks undertaken. Whenever feasible, Prime Innovation will utilize methods outlined in the instrument's service manual. Alternatively, international, regional, or national standards will be referenced when appropriate. In some cases, Prime Innovation may also employ methods developed in-house. The method used for calibration will be clearly indicated on the test report. Nonstandard methods will only be employed with your explicit agreement.</p>

<p><strong>• Turnaround Time:</strong> Normal turnaround time for Prime Innovation calibration services is 2-3 working days depending on workload and service type.</p>

<p><strong>• Pick-up and Delivery:</strong> Prime Innovation provides free pick-up and delivery service from customer premises subject to availability of the sales team.</p>

<p><strong>• Purchase Order Requirement:</strong> Customer's purchase order or written approval is required to commence calibration.</p>

<p><strong>• Partial Invoicing:</strong> Prime Innovation will invoice completed and delivered instruments irrespective of total number of instruments in the PO. Customer is liable to accept partial invoices and proceed with payment.</p>

<p><strong>• Out of Tolerance Units:</strong> If the UUC is found out of tolerance resulting in rejection, 100% of the quoted rate shall be charged.</p>

<p><strong>• Conformity Statement:</strong> Customer must provide written request in advance if conformity statement (PASS/FAIL) is required along with applicable decision rule.</p>

<p><strong>• PAYMENT:</strong> Payment to be made within 30 days from invoice date.</p>

<p><strong>• CONFIDENTIALITY:</strong> All calibration results and documents are treated as confidential unless made public by the customer or required by law.</p>

<p><strong>• VAT:</strong> VAT is excluded from our quotation and will be charged at 15% extra.</p>

<br/>
<p style="text-align: right;">
  <strong>For Prime Innovation Company</strong><br/>
  Hari Krishnan M<br/>
  <em>Head - Engineering and QA/QC</em>
</p>
`;