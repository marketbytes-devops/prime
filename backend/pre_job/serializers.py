        ...
        if recipient_list:
            for email, name in recipient_list:
                ...
                try:
                    ...
                    email_sent = True
                    print(f"RFQ creation email sent successfully to {email} for RFQ #{rfq.series_number}")
                except Exception as e:
                    print(f"Failed to send RFQ creation email to {email} for RFQ #{rfq.series_number}: {str(e)}")
        return email_sent
        ...
        if recipient_list:
            for email, name in recipient_list:
                ...
                try:
                    ...
                    email_sent = True
                    print(f"Quotation submission email sent successfully to {email} for Quotation #{quotation.series_number}")
                except Exception as e:
                    print(f"Failed to send quotation submission email to {email} for Quotation #{quotation.series_number}: {str(e)}")
        return email_sent
